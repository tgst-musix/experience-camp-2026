...
export default function Home() {
  ...
  return <main className={`${styles.site} ${styles.finalSite} ${motion.ready}`}>
    ...
    <section className={styles.scripture} aria-labelledby="scripture-reference"><div className={styles.scriptureInner}><span className={styles.scriptureMark} aria-hidden="true">“</span><blockquote className={styles.scriptureQuote}><span>你要專心仰賴耶和華</span><span>不可倚靠自己的聰明</span><span>在你一切所行的事上都要認定他</span><strong className={styles.scripturePromise}>他必指引你的路</strong></blockquote><p className={styles.scriptureReference} id="scripture-reference">箴言 3:5–6</p></div></section>
